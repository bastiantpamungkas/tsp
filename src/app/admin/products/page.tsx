...
export default function Index() {
    ...
    useEffect(() => {
        if (checkPermission(userData, 'products')) {
            reloadData(paginationModel.page, paginationModel.pageSize, sortModel, filterValue)
        } else {
    ...
    const columns: GridColDef<(typeof products)[number]>[] = [
        ...
        { field: 'price', headerName: 'Price', type: 'number', filterable: false, flex: 1, minWidth: 200, display: 'flex' },
        {
          field: 'action',
          headerName: 'Action',
          sortable: false,
    ...
    const columnsMobile: GridColDef<(typeof products)[number]>[] = [
        { field: 'name', headerName: 'Name', flex: 1, minWidth: 150, display: 'flex', 
          renderCell: (params:any) => {
