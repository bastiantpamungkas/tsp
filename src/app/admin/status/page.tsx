...
export default function Index() {
    ...
    useEffect(() => {
        if (checkPermission(userData, 'status')) {
            reloadData(paginationModel.page, paginationModel.pageSize, sortModel, filterValue)
        } else {
    ...
    const columns: GridColDef<(typeof status)[number]>[] = [
    ...
    const columnsMobile: GridColDef<(typeof status)[number]>[] = [
        { field: 'name', headerName: 'Name', flex: 1, minWidth: 150, display: 'flex', 
          renderCell: (params:any) => {
